...
RSI est distribué sous un modèle **double licence**.

## Usage non commercial — gratuit

Pour les **particuliers**, la **recherche**, l'**éducation** et les
**administrations / gouvernement**, RSI est gratuit sous la
**[PolyForm Noncommercial License 1.0.0](LICENSE.md)**.

Vous pouvez l'utiliser, le modifier et le partager à des fins **non
commerciales**, en conservant la notice de copyright.

## Usage commercial — licence séparée

Tout **usage commercial** (intégration dans un produit ou service payant, usage
