//! Production mirror of SciRust's execution-attestation v1 contract.
//!
//! Source semantics are pinned to `Memorithm/scirust` commit
//! `6a1a594843a02392f69da740ede649a0592a7af9`, upstream path
//! `scirust-agent-protocol/src/execution_attestation.rs`, blob
//! `660f35bcc9ee299b4e8881ce9597aefb33cc5817`. The upstream module's test-only
//! serde_json code is intentionally omitted here so the RSI feature remains
//! lockfile-neutral; the production types, validation, canonical encoding and
//! SHA-256 fingerprint logic are mirrored.
