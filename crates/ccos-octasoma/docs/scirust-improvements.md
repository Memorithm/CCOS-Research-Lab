...
| **A5** wgpu batch scoring | ✅ landed | `gpu` feature — vendored WGSL GEMM (`src/gpu.rs`), `SketchIndex::scores_batch_gpu` = one Q·Eᵀ pass, validated on Mesa lavapipe locally and in CI |
