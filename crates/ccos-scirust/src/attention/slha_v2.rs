...
// reassociation changes accumulation order across builds). Every `unsafe fn`
// carries a `# Safety` contract, and every other `unsafe` site a `// SAFETY:`
// justification or an explicit runtime-detection guard.
#![allow(unsafe_code)]
